...
# ==================== CONFIG ====================
BOT_TOKEN = os.getenv("BOT_TOKEN", "ВАШ_BOT_TOKEN_ЗДЕСЬ")
ADMIN_ID = int(os.getenv("ADMIN_ID", "123456789"))
CARD_DETAILS = os.getenv("CARD_DETAILS", "1234 5678 9012 3456 (Сбер, Иванов И.И.)")
REVIEWS_CHANNEL = os.getenv("REVIEWS_CHANNEL", "@your_reviews_channel")
...
TEXTS = {
    'ru': {
        ...
        'referral_text': "👥 Ваша реферальная ссылка:\nhttps://t.me/{}?start={}\n\nПриглашайте друзей и получайте 10% с их заказов на баланс!",
    ...
    'en': {
        ...
        'referral_text': "👥 Your referral link:\nhttps://t.me/{}?start={}\n\nInvite friends and get 10% from their orders!",
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == 'order_desc':
        ...
        prepayment_text = await get_text(order['user_id'], 'prepayment_required', price) if price < 5000 else await get_text(order['user_id'], 'no_prepayment')
        kb = InlineKeyboardMarkup([
    ...
    if text == t['new_order']:
        ...
        user_data = await get_user(tg_id)
        bot_username = (await context.bot.get_me()).username
        await update.message.reply_text(await get_text(tg_id, 'referral_text', bot_username, user_data['referral_code']))
